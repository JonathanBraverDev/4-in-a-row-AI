...
;  (display "score (for ") (display (state-player state)) (display "): ") (displayln (* -1 (calcScore2 (state-board state) (state-player state)))) ;fail....
  (display "score (for ") (display (opponentMarker (state-player state))) (display "): ") (displayln (state-score state))
